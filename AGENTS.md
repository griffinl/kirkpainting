# AGENTS.md — BlogTemplate

This file orients Codex (and humans) on what this project is and how it fits into a
...
│  Generated site     │   e.g. /Users/liqiang/Documents/Codex/onehousedecor/
│  (Astro, this tmpl) │   auto-rebuilds on git push (Vercel ↔ GitHub integration)
└─────────┬──────────┘
          │ created by
          ▼
┌────────────────────┐   THIS REPO — the template + automation scripts
│  BlogTemplate       │   /Users/liqiang/Documents/Codex/BlogTemplate/
└────────────────────┘
```
...
- **Screenshots**: Codex can read PNG/JPG but NOT TIFF. Ask the user for PNG.
